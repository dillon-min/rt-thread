...
#ifndef __DRV_CS43L22_H__
#define __DRV_CS43L22_H__
...
uint32_t cs43l22_Resume(struct rt_i2c_bus_device *dev, uint16_t DeviceAddr);
uint32_t cs43l22_Stop(struct rt_i2c_bus_device *dev, uint16_t DeviceAddr);
uint32_t cs43l22_SetVolume(struct rt_i2c_bus_device *dev, uint16_t DeviceAddr,
		uint8_t Volume);
uint32_t cs43l22_SetFrequency(struct rt_i2c_bus_device *dev, uint16_t DeviceAddr,
		uint32_t AudioFreq);
uint32_t cs43l22_SetMute(struct rt_i2c_bus_device *dev, uint16_t DeviceAddr,
		uint32_t Cmd);
uint32_t cs43l22_SetOutputMode(struct rt_i2c_bus_device *dev, uint16_t DeviceAddr,
		uint8_t Output);
